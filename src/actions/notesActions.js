...
export const listNotes = () => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(`${env.apiurl}/api/notes`, config);
  ...
  export const deleteNoteAction = (id) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.delete(`${env.apiurl}/api/notes/${id}`, config);
